                ...
                <div class="p-6 sm:p-8 bg-white dark:bg-gray-800">
                    <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 transition duration-150 ease-in-out shadow-sm" type="text" name="name" :value="old('name')" required autofocus />
