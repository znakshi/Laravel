            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700">
                <div class="p-6 sm:p-8 bg-white dark:bg-gray-800">
                    <form method="POST" action="{{ route('categories.update', $category) }}" class="space-y-6">
                        ...
                        <!-- Name -->
                        <div>
                            <x-input-label for="name" :value="__('Category Name')" class="text-gray-700 dark:text-gray-300" />
                            <x-text-input id="name" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 transition duration-150 ease-in-out shadow-sm" type="text" name="name" :value="old('name', $category->name)" required autofocus />
