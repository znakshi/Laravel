                    ...
                    <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 shadow-sm" type="text" name="name" :value="old('name', $supplier->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="contact_name" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 shadow-sm" type="text" name="contact_name" :value="old('contact_name', $supplier->contact_name)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 shadow-sm" type="email" name="email" :value="old('email', $supplier->email)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 shadow-sm" type="text" name="phone" :value="old('phone', $supplier->phone)" />
